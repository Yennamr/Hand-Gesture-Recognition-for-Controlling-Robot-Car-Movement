...
main = tkinter.Tk()
main.title("Hand Gesture Recognition and Voice Conversion for Deaf and Dumb")
...
names = ['Backward', 'Forward', 'Left', 'No-motion', 'Right', 'Stop']
...
font = ('times', 16, 'bold')
title = Label(main, text='Hand Gesture Recognition Using Erode Features Extraction & CNN',anchor=W, justify=CENTER)
